		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-9">
					...
					<h2 class="h2">О «Нисио рю», стиле Нисио</h2>
					<p class="p">
					...
					<h2 class="h2">Путь Нисио-сэнсэя</h2>
					<p class="p">
					...
					<h2 class="h2">Развитие айкидо во Франции и мои первые шаги в айкидо</h2>
					<p class="p">
					...
					<h2 class="h2">Поиски встречи. Первое знакомство. Первое занятие</h2>
					<p class="p">
					...
					<h2 class="h2">Семинары Нисио-сэнсэя во Франции</h2>
					<p class="p">
					...
					<h2 class="h2">Нешлифованный рис</h2>
					<p class="p">
					...
					<h2 class="h2">Исполнение невозможных желаний</h2>
					<p class="p">
					...
					<h2 class="h2">Не философ, но человек дзэн</h2>
					<p class="p">
