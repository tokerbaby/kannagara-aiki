	...
	<body>
        ...
        <div class="container">
            ...
            <figure class="figure text-center">
				<img src="images/preschoolers/kids.jpg" id="kids" class="figure-img img-fluid rounded" alt="На занятии детской группы">
            ...
            <h2 class="h2 class="p"">Как записаться на занятие?</h2>
            ...
            <p class="p">Приходя в первый раз, не нужно заботиться об оплате.</p>
            <p class="p">Ждём Вас!</p>
